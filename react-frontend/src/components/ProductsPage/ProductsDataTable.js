...
const pTemplate1 = (rowData, { rowIndex }) => <p >{rowData.categories}</p>
...
<Column field="categories" header="Categories" body={pTemplate1} filter={selectedFilterFields.includes("categories")} hidden={selectedHideFields?.includes("categories")}  style={{ minWidth: "8rem" }} />
