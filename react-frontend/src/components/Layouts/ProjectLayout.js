...
import DeployJobsPage from "../DeployJobsPage/DeployJobsPage";
...
case "deployJobs":
                return <DeployJobsPage />;
case "deployWorkers":
                return <DeployWorkersPage />;
case "tickets":
                return <TicketsPage />;
case "products":
                return <ProductsPage />;
...
<li
                onClick={() => {
                  setCurrentActiveTab2("deployJobs");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "deployJobs",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "deployJobs" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "deployJobs",
                      "text-black": props?.currentActiveTab2 !== "deployJobs",
                    })}
                  >
                  DeployJobs
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "deployJobs",
                      "text-yellow-700": props?.currentActiveTab2 !== "deployJobs",
                    })}
                  >
...
<li
                onClick={() => {
                  setCurrentActiveTab2("deployWorkers");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "deployWorkers",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "deployWorkers" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "deployWorkers",
                      "text-black": props?.currentActiveTab2 !== "deployWorkers",
                    })}
                  >
                  DeployWorkers
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "deployWorkers",
                      "text-yellow-700": props?.currentActiveTab2 !== "deployWorkers",
                    })}
                  >
                    Accumsan sit amet nulla facilisi morbi tempus iaculis.
                  </p>
